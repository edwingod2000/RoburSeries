...
aI("text=Tournament;showmenu=Toernooi");
...
aI("text=Guestbook;url=javascript:verwerkHeaderMenuKeuze(15)");
...
aI("text=About the Series;url=javascript:verwerkHeaderMenuKeuze(19)");
aI("text=Program;url=javascript:verwerkHeaderMenuKeuze(20)");
aI("text=Rules;url=javascript:verwerkHeaderMenuKeuze(12)");
aI("text=Accomodation;url=javascript:verwerkHeaderMenuKeuze(14)");
aI("text=Following years;url=javascript:verwerkHeaderMenuKeuze(18)");
aI("text=About Robur '58;url=javascript:verwerkHeaderMenuKeuze(21)");
aI("text=About the ballpark;url=javascript:verwerkHeaderMenuKeuze(22)");
...
aI("text=Games;url=javascript:verwerkHeaderMenuKeuze(3)");
...
overflow="scroll";
style=subMenuStyle;
aI("text=Date;url=javascript:verwerkHeaderMenuKeuze(18)");
aI("text=Registration;url=javascript:verwerkHeaderMenuKeuze(17)");
aI("text=Accomodation;url=javascript:verwerkHeaderMenuKeuze(14)");
}
